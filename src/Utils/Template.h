...
#define TO_RADIANS(degrees) degrees *static_cast<float>(0.01745329251994329576923690768489)
...
inline glm::vec3 RandomPointOnHemisphere(const glm::vec3 &normal, RandomGenerator &rng)
{
    glm::vec3 Nt, Nb;

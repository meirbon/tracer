...
#if CAP_PITCH
#define MAX_PITCH glm::radians(89.f)
#define MIN_PITCH glm::radians(-89.f)
#endif
...
class Camera
{
  public:
    ...
    inline void SetPosition(glm::vec3 position) noexcept
    {
        this->m_Origin = position;
    }

    inline glm::vec3 GetViewDirection() const noexcept
    {

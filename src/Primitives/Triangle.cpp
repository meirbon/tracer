...
Triangle::Triangle(vec3 p0, vec3 p1, vec3 p2, uint matIndex, vec2 t0, vec2 t1,
                   vec2 t2)
...
Triangle::Triangle(glm::vec3 p0, glm::vec3 p1, glm::vec3 p2, glm::vec3 n0,
                   glm::vec3 n1, glm::vec3 n2, uint matIndex)
...
Triangle::Triangle(glm::vec3 p0, glm::vec3 p1, glm::vec3 p2, glm::vec3 n0,
                   glm::vec3 n1, glm::vec3 n2, uint matIndex, glm::vec2 t0,
...
Triangle::Triangle(vec3 p0, vec3 p1, vec3 p2, uint matIndex)
    : p0(p0), p1(p1), p2(p2), t0(vec3(-1.f, -1.f, -1.f))
{
    this->materialIdx = matIndex;
    this->normal = normalize(cross(p1 - p0, p2 - p0));
    this->n0 = this->n1 = this->n2 = normal;
...
vec3 Triangle::GetRandomPointOnSurface(const vec3 &direction, vec3 &lNormal,

...
class Triangle : public Light
{
  public:
    Triangle() = default;
    Triangle(vec3 p0, vec3 p1, vec3 p2, uint matIndex);
    Triangle(vec3 p0, vec3 p1, vec3 p2, uint matIndex, vec2 t0, vec2 t1,
             vec2 t2);
    Triangle(vec3 p0, vec3 p1, vec3 p2, vec3 n0, vec3 n1, vec3 n2,
             uint matIndex);
    Triangle(vec3 p0, vec3 p1, vec3 p2, vec3 n0, vec3 n1, vec3 n2,
    ...
    vec3 GetRandomPointOnSurface(const vec3 &direction, vec3 &lNormal,

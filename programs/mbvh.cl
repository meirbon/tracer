...
void IntersectMBVHTree(global MBVHNode* nodes, global Triangle* triangles, global uint* primitiveIndices, global Ray* ray);
...
inline MBVHHit IntersectMBVHNode(global MBVHNode* node, global Ray* ray)
{
    ...
    hit.tmini[0] &= 0xFFFFFFFC;
    hit.tmini[1] &= 0xFFFFFFFC;
    hit.tmini[2] &= 0xFFFFFFFC;
    hit.tmini[3] &= 0xFFFFFFFC;

    hit.tmini[0] = (hit.tmini[0] | 0b00);
    hit.tmini[1] = (hit.tmini[1] | 0b01);
    hit.tmini[2] = (hit.tmini[2] | 0b10);
    hit.tmini[3] = (hit.tmini[3] | 0b11);
...
inline void IntersectMBVHTree(global MBVHNode* nodes, global Triangle* triangles, global uint* primitiveIndices, global Ray* ray)
{
...
inline void IntersectMBVHTreeRay(global MBVHNode* nodes, global Triangle* triangles, global uint* primitiveIndices, Ray* ray)
{
    struct MBVHTraversal todo[64];
    struct MBVHHit hit;
    int stackptr = 0;

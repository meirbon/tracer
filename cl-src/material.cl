...
float3 getColor(Material mat, global float3 *textures, global TextureInfo *texInfo, float2 texCoords);

inline float3 getColor(Material mat, global float3 *textures, global TextureInfo *texInfo, float2 texCoords)
{
	if (mat.textureIdx > -1)
	{
